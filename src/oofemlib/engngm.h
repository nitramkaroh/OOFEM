...
public:
	...
	IG_Secant = 2, ///< Solves an approximated tangent problem from the last iteration. Useful for changing Dirichlet boundary conditions.
...
public:
    ...
    void reduceTimeStep(TimeStep *tStep);
    ...
    bool isAnalysisCrashed(){return analysisCrash;}
    void setAnalysisCrash(bool ac){analysisCrash = ac;}
