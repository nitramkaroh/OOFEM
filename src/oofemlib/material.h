...
public:
    ...
    /**
     * Functions used by many material models, such as calculation of J2 invariant
     * its first and second derivative, more methods to be added in the future
     */

    
    /*
     * Returns the second deviatoric invariant of stress tensor.
     * @param stressVector stress vector in full form
     */
    static double computeJ2StressInvariantAt(const FloatArray &stressVector);

    /*
     * Returns second deviatoric invariant of stress tensor.
     * @param stressVector stress vector in full form.
     * @param s deviatoric stress vector.
     * @param p volumetric part of stress vector.
     */    
    static double computeJ2StressInvariantAt(const FloatArray &stressVector, FloatArray &s, double &p);


    /*
     * Computes the first derivative of the square root of the second deviatoric invariant wrt stress.
     * @param answer computed first derivative of sqrt(J2) wrt stress.
     * @param p volumetric part of stress vector.
     */         
    static void compute_dSqrtJ2StressInvariant_dStressAt(FloatArray &answer, const FloatArray &stressVector);

    /*
     * Computes the second derivative of the square root of the second deviatoric invariant wrt stress.
     * @param answer computed second derivative of sqrt(J2) wrt stress.
     * @param p volumetric part of stress vector.
     */    
    static void compute_d2SqrtJ2StressInvariant_dStress2At(FloatMatrix &answer, const FloatArray &stressVector);
