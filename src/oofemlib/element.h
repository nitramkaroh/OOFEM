...
public:
     ...
     * @param tStep  Time step when answer is computed.
     */
    virtual void giveSurfaceCharacteristicMatrix(FloatMatrix &answer, CharType type, TimeStep *tStep);
    /**
     * Computes characteristic vector of receiver of requested type in given time step.
     * If element has no capability to compute requested type of characteristic vector
     * error function is invoked.
     ...
     * @param tStep  Time step when answer is computed.
     */
    virtual void giveSurfaceCharacteristicVector(FloatArray &answer, CharType type, ValueModeType mode, TimeStep *tStep);
    ...
    /**
     * Returns coordinates of element centroid in parametric space     
     * @param answer coordinates of the element parametric centroid
     */
    virtual void giveElementParametricCentroid(FloatArray &answer){OOFEM_ERROR( "giveElementParametricCentroid is not supported by this element" );}
    ...
    virtual bool hasSurfaceEnergy() {return false;}
