...
#define _IFT_LSpaceElectroMechanicalElement_Name "lspaceelmechelem"
 ...
 */
class LSpaceElectroMechanicalElement  :  public LSpace, public BaseElectroMechanicalElement
{
protected:
    static FEI3dHexaLin interpolation;
public:
    LSpaceElectroMechanicalElement(int n, Domain * d);
    virtual ~LSpaceElectroMechanicalElement() { }
    virtual FEInterpolation *giveInterpolation() const;

    // definition & identification
    virtual const char *giveInputRecordName() const { return _IFT_LSpaceElectroMechanicalElement_Name; }
    virtual const char *giveClassName() const { return "LSpaceElectroMechanicalElement"; }
