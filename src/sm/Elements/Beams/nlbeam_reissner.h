...
#ifndef nlbeam_reissner_h
#define nlbeam_reissner_h
...
#define _IFT_NlBeam_Reissner_NIP "nip"
#define _IFT_NlBeam_Reissner_EA "ea"
#define _IFT_NlBeam_Reissner_EI "ei"
#define _IFT_NlBeam_Reissner_GAs "gas"
#define _IFT_NlBeam_Reissner_initialCurvature "initialcurvature"
#define _IFT_NlBeam_Reissner_RADIUS "radius"
#define _IFT_NlBeam_Reissner_DEPTH "depth"
#define _IFT_NlBeam_Reissner_Material "materialtype"
#define _IFT_NlBeam_Reissner_Beam_Tolerance "btol"
#define _IFT_NlBeam_Reissner_Beam_MaxIteration "bmaxit"
#define _IFT_NlBeam_SM_Beam_NumberMaxSubsteps "nsubsteps"
#define _IFT_NlBeam_Reissner_Section_Tolerance "stol"
#define _IFT_NlBeam_Reissner_Section_MaxIteration "smaxit"

#define _IFT_NlBeam_Reissner_pressure "pressure"
#define _IFT_NlBeam_Reissner_pressureLTF "pressure_ltf"

#define _IFT_NlBeam_Reissner_s "s"
#define _IFT_NlBeam_Reissner_u0 "u0"
#define _IFT_NlBeam_Reissner_w0 "w0"
#define _IFT_NlBeam_Reissner_phi0 "phi0"
#define _IFT_NlBeam_Reissner_kappa0 "kappa0"
#define _IFT_NlBeam_Reissner_tangentVector "tv"

#define _IFT_NlBeam_Reissner_beta "beta"
#define _IFT_NlBeam_Reissner_curvedbeamLength "curvedbeamlength"
#define _IFT_NlBeam_Reissner_coordinateFlag "cf"
 ...
 */
  class NlBeam_Reissner : public NLStructuralElement, public VTKXMLExportModuleElementInterface
{
protected:
    int NIP = 100;
    int NIP_left = 0;
...
public:
    NlBeam_Reissner(int n, Domain *aDomain);
    ...
    virtual const char *giveClassName() const { return "NlBeam_Reissner"; }
    virtual const char *giveInputRecordName() const { return _IFT_NlBeam_Reissner_Name; }
