...
#ifndef qplanestrainmicrodil_h
#define qplanestrainmicrodil_h

#include "../sm/Elements/PlaneStrain/qplanestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_QPlaneStrainMicrodil_Name "qplanestrainmicrodil"

namespace oofem {
class FEI2dQuadLin;

class QPlaneStrainMicrodil : public QPlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadQuad interpolation;

public:
    QPlaneStrainMicrodil(int n, Domain * d);
    virtual ~QPlaneStrainMicrodil() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_QPlaneStrainMicrodil_Name; }
    virtual const char *giveClassName() const { return "QPlaneStrainMicrodil"; }
