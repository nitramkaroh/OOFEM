...
#ifndef trplanestrainmicrodil_h
#define trplanestrainmicrodil_h

#include "../sm/Elements/PlaneStrain/trplanestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_TrPlaneStrainMicrodil_Name "trplanestrainmicrodil"

namespace oofem {
class FEI2dTrLin;

class TrPlaneStrainMicrodil : public TrPlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dTrLin interpolation;

public:
    TrPlaneStrainMicrodil(int n, Domain * d);
    virtual ~TrPlaneStrainMicrodil() { }
 ...
 protected:
    ...
    virtual void computeMacromorphicBMatrixAt(GaussPoint *gp, FloatMatrix &B){this->computeMicromorphicBMatrixAt(gp,B);}
    virtual NLStructuralElement *giveElement() { return this; }
 public:
    virtual const char *giveInputRecordName() const { return _IFT_TrPlaneStrainMicrodil_Name; }
    virtual const char *giveClassName() const { return "TrPlaneStrainMicrodil"; }
