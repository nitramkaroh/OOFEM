...
#ifndef planestrainmicromorphic_h
#define planestrainmicromorphic_h

#include "../sm/Elements/PlaneStrain/quad1planestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStrainMicromorphic_Name "planestrainmicromorphic"

namespace oofem {
class FEI2dQuadLin;

class PlaneStrainMicromorphic : public Quad1PlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadLin interpolation;

public:
    PlaneStrainMicromorphic(int n, Domain * d);
    virtual ~PlaneStrainMicromorphic() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_PlaneStrainMicromorphic_Name; }
    virtual const char *giveClassName() const { return "PlaneStrainMicromorphic"; }
