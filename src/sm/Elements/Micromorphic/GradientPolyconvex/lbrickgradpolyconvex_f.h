...
#ifndef lbrickgradpolyconvex_f_h
#define lbrickgradpolyconvex_f_h

#include "../sm/Elements/3d/lspace.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStrainGradPolyconvex_Name "lbrickgradpolyconvex_f"

namespace oofem {
class FEI3dhexalin;

class LBrickGradPolyconvex_F : public LSpace, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadLin interpolation;

public:
    LBrickGradPolyconvex_F(int n, Domain * d);
    virtual ~LBrickGradPolyconvex_F() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_LBrickGradPolyconvex_F_Name; }
    virtual const char *giveClassName() const { return "LBrickGradPolyconvex_F"; }
