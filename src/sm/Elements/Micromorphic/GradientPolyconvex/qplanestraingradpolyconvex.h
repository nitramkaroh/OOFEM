...
#ifndef qplanestraingradpolyconvex_h
#define qplanestraingradpolyconvex_h

#include "../sm/Elements/PlaneStrain/qplanestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_QPlaneStrainGradPolyconvex_Name "qplanestraingradpolyconvex"

namespace oofem {
class FEI2dQuadLin;

class QPlaneStrainGradPolyconvex : public QPlaneStrain, public BaseMicromorphicElement
{
protected:

public:
    QPlaneStrainGradPolyconvex(int n, Domain * d);
    virtual ~QPlaneStrainGradPolyconvex() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_QPlaneStrainGradPolyconvex_Name; }
    ...
    virtual int giveNumberOfMicromorphicDofs(){return 40;}
