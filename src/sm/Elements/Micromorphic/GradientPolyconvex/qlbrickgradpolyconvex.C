...
#include "../sm/Elements/Micromorphic/GradientPolyconvex/qlbrickgradpolyconvex.h"
...
namespace oofem {
REGISTER_Element(QLBrickGradPolyconvex);
  
FEI3dHexaLin QLBrickGradPolyconvex :: micro_interpolation;

QLBrickGradPolyconvex :: QLBrickGradPolyconvex(int n, Domain *aDomain) : QSpace(n, aDomain), BaseMicromorphicElement()
    // Constructor.
{
  int index = 0;
...
void 
QLBrickGradPolyconvex :: computeMicromorphicNMatrixAt(GaussPoint *gp,FloatMatrix &answer)
{
    FloatArray n;
...
void
QLBrickGradPolyconvex :: computeMicromorphicBMatrixAt(GaussPoint *gp, FloatMatrix &answer)         
{
    FloatMatrix dNdx; 
...
void
QLBrickGradPolyconvex :: computeMicromorphicVars(FloatArray &micromorphicVar,FloatArray &micromorphicVarGrad, IntArray IdMask_m, GaussPoint *gp, TimeStep *tStep)
{
  FloatMatrix N_m, B_m;
  FloatArray u_m;
...
void
QLBrickGradPolyconvex :: giveDofManDofIDMask(int inode, IntArray &answer) const
{
  if(inode <= 8) {
...
void
QLBrickGradPolyconvex :: giveDofManDofIDMask_u(IntArray &answer)
{
  answer = {D_u, D_v, D_w};
}
...
void
QLBrickGradPolyconvex :: giveDofManDofIDMask_m(IntArray &answer)
{
...
void
QLBrickGradPolyconvex ::  postInitialize() 
{
