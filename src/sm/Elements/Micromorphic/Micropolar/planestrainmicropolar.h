...
#ifndef planestrainmicropolar_h
#define planestrainmicropolar_h

#include "../sm/Elements/PlaneStrain/quad1planestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStrainMicropolar_Name "planestrainmicropolar"

namespace oofem {
class FEI2dQuadLin;

class PlaneStrainMicropolar : public Quad1PlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadLin interpolation;

public:
    PlaneStrainMicropolar(int n, Domain * d);
    virtual ~PlaneStrainMicropolar() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_PlaneStrainMicropolar_Name; }
    virtual const char *giveClassName() const { return "PlaneStrainMicropolar"; }
