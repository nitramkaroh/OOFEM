...
#ifndef planestressmicropolar_h
#define planestressnmicropolar_h

#include "../sm/Elements/PlaneStress/planstrss.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStressMicropolar_Name "planestressmicropolar"

namespace oofem {
class FEI2dQuadLin;

class PlaneStressMicropolar : public PlaneStress2d, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadLin interpolation;

public:
    PlaneStressMicropolar(int n, Domain * d);
    virtual ~PlaneStressMicropolar() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_PlaneStressMicropolar_Name; }
    virtual const char *giveClassName() const { return "PlaneStressMicropolar"; }
