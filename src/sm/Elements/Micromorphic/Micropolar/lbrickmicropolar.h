...
#ifndef lbrickmicropolar_h
#define lbrickmicropolar_h

#include "../sm/Elements/3D/lspace.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_LBrickMicropolar_Name "lbrickmicropolar"

namespace oofem {
class FEI3dhexalin;

class LBrickMicropolar : public LSpace, public BaseMicromorphicElement
{
protected:
    static FEI3dHexaLin interpolation;

public:
    LBrickMicropolar(int n, Domain * d);
    virtual ~LBrickMicropolar() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_LBrickMicropolar_Name; }
    virtual const char *giveClassName() const { return "LBrickMicropolar"; }
    ...
    virtual int giveNumberOfMicromorphicDofs(){return 24;}
    virtual int giveNumberOfDisplacementDofs(){return 24;}
    virtual int giveNumberOfDofs(){return 48;}
