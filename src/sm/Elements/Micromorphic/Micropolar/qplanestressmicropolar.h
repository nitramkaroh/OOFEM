...
#define _IFT_QPlaneStressMicropolar_Name "qplanestressmicropolar"

namespace oofem {
class FEI2dQuadLin;

class QPlaneStressMicropolar : public QPlaneStress2d, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadQuad interpolation;

public:
    QPlaneStressMicropolar(int n, Domain * d);
    virtual ~QPlaneStressMicropolar() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_QPlaneStressMicropolar_Name; }
    virtual const char *giveClassName() const { return "QPlaneStressMicropolar"; }
...
#endif // planestressmicromorphic_h
