...
#ifndef planestrainmicrostretch_h
#define planestrainmicrostretch_h

#include "../sm/Elements/PlaneStrain/quad1planestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStrainMicrostretch_Name "planestrainmicrostretch"

namespace oofem {
class FEI2dQuadLin;

class PlaneStrainMicrostretch : public Quad1PlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadLin interpolation;

public:
    PlaneStrainMicrostretch(int n, Domain * d);
    virtual ~PlaneStrainMicrostretch() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_PlaneStrainMicrostretch_Name; }
    virtual const char *giveClassName() const { return "PlaneStrainMicrostretch"; }
...
#endif // planestrainmicrostretch_h
