...
#ifndef qplanestrainmicroplastic_h
#define qplanestrainmicroplastic_h

#include "../sm/Elements/PlaneStrain/qplanestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_QPlaneStrainMicroplastic_Name "qplanestrainmicroplastic"

namespace oofem {
class FEI2dQuadLin;

class QPlaneStrainMicroplastic : public QPlaneStrain, public BaseMicromorphicElement
{
protected:
    static FEI2dQuadQuad interpolation;

public:
    QPlaneStrainMicroplastic(int n, Domain * d);
    virtual ~QPlaneStrainMicroplastic() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_QPlaneStrainMicroplastic_Name; }
    virtual const char *giveClassName() const { return "QPlaneStrainMicroplastic"; }
