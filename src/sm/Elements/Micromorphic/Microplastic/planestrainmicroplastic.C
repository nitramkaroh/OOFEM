...
#include "../sm/Elements/Micromorphic/Microplastic/planestrainmicroplastic.h"
...
namespace oofem {
REGISTER_Element(PlaneStrainMicroplastic);


PlaneStrainMicroplastic :: PlaneStrainMicroplastic(int n, Domain *aDomain) : Quad1PlaneStrain(n, aDomain), BaseMicromorphicElement()
    // Constructor.
{
...
void 
PlaneStrainMicroplastic :: computeMicromorphicNMatrixAt(GaussPoint *gp,FloatMatrix &answer)
{
    FloatArray n;
...
void
PlaneStrainMicroplastic :: giveDofManDofIDMask(int inode, IntArray &answer) const
{
  answer = {D_u, D_v, M_MP};
}
