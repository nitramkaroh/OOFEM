...
#ifndef planestrainmicroplastic_h
#define planestrainmicroplastic_h

#include "../sm/Elements/PlaneStrain/quad1planestrain.h"
#include "../sm/Elements/Micromorphic/basemicromorphicelement.h"

#define _IFT_PlaneStrainMicroplastic_Name "planestrainmicroplastic"

namespace oofem {
class PlaneStrainMicroplastic : public Quad1PlaneStrain, public BaseMicromorphicElement
{

public:
    PlaneStrainMicroplastic(int n, Domain * d);
    virtual ~PlaneStrainMicroplastic() { }
 ...
 public:
    virtual const char *giveInputRecordName() const { return _IFT_PlaneStrainMicroplastic_Name; }
    virtual const char *giveClassName() const { return "PlaneStrainMicroplastic"; }
...
#endif // planestrainmicroplastic_h
