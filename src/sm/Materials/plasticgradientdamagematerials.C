...
#include "plasticgradientdamagematerials.h"
...
namespace oofem {
REGISTER_Material(VonMisesGradientDamageMaterial);

VonMisesGradientDamageMaterial :: VonMisesGradientDamageMaterial(int n, Domain * d) : SimplePlasticGradientDamageMaterial(n, d)
{
...
IRResultType
VonMisesGradientDamageMaterial :: initializeFrom(InputRecord *ir)
{

    // Required by IR_GIVE_FIELD macro
    IRResultType result;
    // call the corresponding service of simple plastic material
    result = SimplePlasticGradientDamageMaterial :: initializeFrom(ir);
    ...
    IR_GIVE_FIELD(ir, sig0, _IFT_VonMisesGradientDamageMaterial_sig0); // uniaxial yield stress
...
double
VonMisesGradientDamageMaterial :: computeYieldValueAt(GaussPoint *gp, int isurf, const FloatArray &stressVector,
...
void
VonMisesGradientDamageMaterial :: computeStressGradientVector(FloatArray &answer, functType ftype, int isurf, GaussPoint *gp, const FloatArray &stressVector, const FloatArray &strainSpaceHardeningVars)
{
...
void
VonMisesGradientDamageMaterial :: computeReducedSSGradientMatrix(FloatMatrix &gradientMatrix,  int isurf, GaussPoint *gp, const FloatArray &fullStressVector,
                                        const FloatArray &strainSpaceHardeningVars)
{
  IntArray mask;
...
void
VonMisesGradientDamageMaterial :: computeReducedHardeningVarsLamGradient(FloatMatrix &answer, GaussPoint *gp, int actSurf,
...
void
VonMisesGradientDamageMaterial :: computeStrainHardeningVarsIncrement(FloatArray &answer, GaussPoint *gp,
