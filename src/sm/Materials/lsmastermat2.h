...
#ifndef lsmastermat2_h
#define lsmastermat2_h
...
//@{
#define _IFT_LargeStrainMasterMaterial2_Name "lsmastermat2"
#define _IFT_LargeStrainMasterMaterial2_m "m"
#define _IFT_LargeStrainMasterMaterial2_slaveMat "slavemat"
//@}
 ...
 */
class LargeStrainMasterMaterial2 : public StructuralMaterial
{
protected:
...
public:
    LargeStrainMasterMaterial2(int n, Domain *d);
    virtual ~LargeStrainMasterMaterial2();

    virtual IRResultType initializeFrom(InputRecord *ir);

    virtual int hasNonLinearBehaviour() { return 1; }
    virtual const char *giveInputRecordName() const { return _IFT_LargeStrainMasterMaterial2_Name; }
    virtual const char *giveClassName() const { return "LargeStrainMasterMaterial2"; }
...
class LargeStrainMasterMaterial2Status : public StructuralMaterialStatus
{
protected:
...
public:
    LargeStrainMasterMaterial2Status(int n, Domain *d, GaussPoint *g, int s);
    virtual ~LargeStrainMasterMaterial2Status();
    ...
    virtual const char *giveClassName() const { return "LargeStrainMasterMaterial2Status"; }
};
} // end namespace oofem
#endif // misesmat_h
