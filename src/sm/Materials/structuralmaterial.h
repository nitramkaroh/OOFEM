...
public:
    ...
    virtual void giveRealStressVector_Warping(FloatArray &answer, GaussPoint *gp, const FloatArray &reducedE, TimeStep *tStep);
        /// Default implementation relies on giveRealStressVector_StressControl
    virtual void giveRealStressVector_AxisymMembrane1d(FloatArray &answer, GaussPoint *gp, const FloatArray &reducedE, TimeStep *tStep);
    /// Default implementation relies on giveRealStressVector_StressControl
    ...
    //third elasticity tensor a_ijkl = c_ijkl + tau_kl delta_ij
    ...
    virtual void giveSpatialPlaneStressStiffMtrx(FloatMatrix &answer,
                                               MatResponseMode mmode, GaussPoint *gp,
                                               TimeStep *tStep);
    //@}
    ...
    virtual void giveSpatialPlaneStrainStiffMtrx(FloatMatrix &answer,
                                               MatResponseMode mmode, GaussPoint *gp,
                                               TimeStep *tStep);
    //@}
    ...
    virtual void giveSpatial1dStressStiffMtrx(FloatMatrix &answer,
                                            MatResponseMode mmode, GaussPoint *gp,
                                            TimeStep *tStep);

    virtual void  giveInitialStiffnessMatrix_Cauchy(FloatMatrix &answer,
                                                  MatResponseMode mode,
						    GaussPoint *gp, TimeStep *tStep);


    virtual void giveStiffnessMatrix_AxisymMembrane1d(FloatMatrix &answer,
                                       MatResponseMode mmode, GaussPoint *gp,
                                       TimeStep *tStep);
