...
namespace oofem {
  ...
  SimplePlasticMaterial :: SimplePlasticMaterial(int n, Domain *d) : MPlasticDamageMaterial2(n, d), IsotropicHardeningMaterialExtensionInterface(d), IsotropicDamageMaterialExtensionInterface(d), 
{
    //
    // constructor
    //
