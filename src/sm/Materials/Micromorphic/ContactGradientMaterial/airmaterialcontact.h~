...
//@{
#define _IFT_StVenantKirchhoffGradientPolyconvexMaterial_Name "stvenantkirchhoffgradientpolyconvexmaterial"
//@}

namespace oofem {

  class StVenantKirchhoffGradientPolyconvexMaterialStatus : public MicromorphicMaterialStatus
 {
 public:
   StVenantKirchhoffGradientPolyconvexMaterialStatus(int n, Domain *d, GaussPoint *g, bool sym);  
   ~StVenantKirchhoffGradientPolyconvexMaterialStatus(){;}
 };

/**
 * MicromorphicLinearElasticMaterial
 */
class StVenantKirchhoffGradientPolyconvexMaterial : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:

public:
    StVenantKirchhoffGradientPolyconvexMaterial(int n, Domain * d);
    virtual ~StVenantKirchhoffGradientPolyconvexMaterial();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_StVenantKirchhoffGradientPolyconvexMaterial_Name; }
...
protected:
    virtual MaterialStatus *CreateStatus(GaussPoint *gp) const { return new StVenantKirchhoffGradientPolyconvexMaterialStatus(1, domain, gp, true); }
