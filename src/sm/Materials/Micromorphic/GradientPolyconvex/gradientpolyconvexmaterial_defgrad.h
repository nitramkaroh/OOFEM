...
#ifndef gradientpolyconvexmaterial_defgrad_h
#define gradientpolyconvexmaterial_defgrad_h
...
//@{
#define _IFT_GradientF_PolyconvexMaterial_Name "gradientpolyconvexmaterial_defgrad"
#define _IFT_GradientF_PolyconvexMaterial_eps "eps"
#define _IFT_GradientF_PolyconvexMaterial_alpha "alpha"
//@}

namespace oofem {

  class GradientF_PolyconvexMaterialStatus : public MicromorphicMaterialStatus
 {
 public:
   GradientF_PolyconvexMaterialStatus(int n, Domain *d, GaussPoint *g, bool sym);  
   ~GradientF_PolyconvexMaterialStatus(){;}
 };

/**
 * MicromorphicLinearElasticMaterial
 */
class GradientF_PolyconvexMaterial : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:
  double eps;
  double alpha;
...
public:
    ...
    virtual ~GradientF_PolyconvexMaterial();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_GradientF_PolyconvexMaterial_Name; }
    virtual const char *giveClassName() const { return "GradientF_PolyconvexMaterial"; }
