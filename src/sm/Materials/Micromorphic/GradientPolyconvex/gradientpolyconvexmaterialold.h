...
#ifndef gradientpolyconvexold_h
#define gradientpolyconvexold_h
...
//@{
#define _IFT_GradientPolyconvexMaterialOld_Name "gradientpolyconvexmaterialold"
#define _IFT_GradientPolyconvexMaterialOld_eps "eps"
#define _IFT_GradientPolyconvexMaterialOld_alpha "alpha"
#define _IFT_GradientPolyconvexMaterialOld_gamma "gamma"
//@}

namespace oofem {

  class GradientPolyconvexMaterialOldStatus : public MicromorphicMaterialStatus
 {
 public:
   GradientPolyconvexMaterialOldStatus(int n, Domain *d, GaussPoint *g, bool sym);  
   ~GradientPolyconvexMaterialOldStatus(){;}
 };

/**
 * MicromorphicLinearElasticMaterial
 */
class GradientPolyconvexMaterialOld : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:
  double eps;
  double alpha;
...
public:
    GradientPolyconvexMaterialOld(int n, Domain * d);
    virtual ~GradientPolyconvexMaterialOld();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_GradientPolyconvexMaterialOld_Name; }
    virtual const char *giveClassName() const { return "GradientPolyconvexMaterialOld"; }
...
protected:
    virtual MaterialStatus *CreateStatus(GaussPoint *gp) const { return new GradientPolyconvexMaterialOldStatus(1, domain, gp, true); }
