...
//@{
#define _IFT_StVenantKirchhoffGradientPolyconvexMaterialF_Name "stvenantkirchhoffgradientpolyconvexmaterialf"
//@}

namespace oofem {

  class StVenantKirchhoffGradientPolyconvexMaterialFStatus : public MicromorphicMaterialStatus
 {
 public:
   StVenantKirchhoffGradientPolyconvexMaterialFStatus(int n, Domain *d, GaussPoint *g, bool sym);  
   ~StVenantKirchhoffGradientPolyconvexMaterialFStatus(){;}
 };

/**
 * MicromorphicLinearElasticMaterial
 */
class StVenantKirchhoffGradientPolyconvexMaterialF : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:

public:
    StVenantKirchhoffGradientPolyconvexMaterialF(int n, Domain * d);
    virtual ~StVenantKirchhoffGradientPolyconvexMaterialF();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_StVenantKirchhoffGradientPolyconvexMaterialF_Name; }
    virtual const char *giveClassName() const { return "StVenantKirchhoffGradientPolyconvexMaterialF"; }
...
protected:
    virtual MaterialStatus *CreateStatus(GaussPoint *gp) const { return new StVenantKirchhoffGradientPolyconvexMaterialFStatus(1, domain, gp, true); }
