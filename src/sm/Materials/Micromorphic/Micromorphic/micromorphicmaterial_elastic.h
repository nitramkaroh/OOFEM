...
#ifndef micromorphicmaterial_elastic_h
#define micromorphicmaterial_elastic_h
...
//@{
#define _IFT_MicromorphicMaterial_Elastic_Name "micromorphic_elastic"
 ...
 */
class MicromorphicMaterial_Elastic : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:

public:
    MicromorphicMaterial_Elastic(int n, Domain * d);
    virtual ~MicromorphicMaterial_Elastic();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_MicromorphicMaterial_Elastic_Name; }
    virtual const char *giveClassName() const { return "MicromorphicMaterial_Elastic"; }
