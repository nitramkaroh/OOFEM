...
//@{
#define _IFT_MicropolarMaterial_Elastic_Name "micropolar_elastic"
 ...
 */
class MicropolarMaterial_Elastic : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:

public:
    MicropolarMaterial_Elastic(int n, Domain * d);
    virtual ~MicropolarMaterial_Elastic();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_MicropolarMaterial_Elastic_Name; }
    virtual const char *giveClassName() const { return "MicropolarMaterial_Elastic"; }
