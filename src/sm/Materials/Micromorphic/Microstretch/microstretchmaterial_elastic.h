...
#ifndef microstretch_elastic_h
#define microstretch_elastic_h
...
//@{
#define _IFT_Microstretch_Elastic_Name "microstretch_elastic"
 ...
 */
class Microstretch_Elastic : public IsotropicLinearElasticMaterial, MicromorphicMaterialExtensionInterface
{
protected:

public:
    Microstretch_Elastic(int n, Domain * d);
    virtual ~Microstretch_Elastic();

    // definition
    virtual const char *giveInputRecordName() const { return _IFT_Microstretch_Elastic_Name; }
    virtual const char *giveClassName() const { return "Microstretch_Elastic"; }
