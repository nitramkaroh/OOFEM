...
public:
    ...
    const FloatArray & giveStrainSpaceHardeningVarsVector() const { return strainSpaceHardeningVarsVector; }
...
protected:
    ...
    virtual void give_dLambda_dEps_Matrix(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep);
    virtual void giveStiffnessCorrection(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep);
protected:
