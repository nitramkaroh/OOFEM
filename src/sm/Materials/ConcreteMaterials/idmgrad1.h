 ...
 */
class IDGMaterial : public IsotropicDamageMaterial1, GradientDamageMaterialExtensionInterface
{
protected:
 ...
 */
class IDGMaterialStatus : public IsotropicDamageMaterial1Status, GradientDamageMaterialStatusExtensionInterface
{
public:
