...
public:
    ...
    virtual void  giveRealStress_AxisymMembrane1d(FloatArray &answer, GaussPoint *gp, const FloatArray &strain, TimeStep *tStep);
    ...
    virtual void giveStiffnessMatrix_AxisymMembrane1d(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp, TimeStep *tStep);
    ...
    { OOFEM_ERROR("not implemented"); }
    virtual void giveSpatialStiffnessMatrix(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp, TimeStep *tStep)
    { OOFEM_ERROR("not implemented"); }
    virtual void giveInitialStiffnessMatrix_Cauchy(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp, TimeStep *tStep){ OOFEM_ERROR("not implemented");}
