...
#ifndef simpleelectromechanicalcrosssection_h
#define simpleelectromechanicalcrosssection_h
...
//@{
#define _IFT_SimpleElectroMechanicalCrossSection_Name "simpleemcs"
#define _IFT_SimpleElectroMechanicalCrossSection_thick "thick"
#define _IFT_SimpleElectroMechanicalCrossSection_width "width"
#define _IFT_SimpleElectroMechanicalCrossSection_area "area"
#define _IFT_SimpleElectroMechanicalCrossSection_MaterialNumber "material" ///< Material number for the bulk material
//@}
 ...
 *
 */
class OOFEM_EXPORT SimpleElectroMechanicalCrossSection : public CrossSection
{
public:
    /**
     * Constructor.
     ...
     */
    SimpleElectroMechanicalCrossSection(int n, Domain *d) : CrossSection(n, d) {
        materialNumber = 0;
        czMaterialNumber = 0;
    }
    ...
    void give_FirstPKStressVector_ElectricDisplacementVector(FloatArray &P, FloatArray &D, GaussPoint *gp, const FloatArray &F, const FloatArray &E, TimeStep *tStep);
    void giveElectroMechanicalConstitutiveMatrix_dPdF(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp,TimeStep *tStep);
    void giveElectroMechanicalConstitutiveMatrix_dPdE(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp,TimeStep *tStep);
    void giveElectroMechanicalConstitutiveMatrix_dDdE(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp,TimeStep *tStep);
    ...
    virtual const char *giveClassName() const { return "SimpleElectroMechanicalCrossSection"; }
    virtual const char *giveInputRecordName() const { return _IFT_SimpleElectroMechanicalCrossSection_Name; }
