...
public:
    ...
    virtual void giveSpatialStiffnessMatrix(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep);
    virtual void giveInitialStiffnessMatrix_Cauchy(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp, TimeStep *tStep);
